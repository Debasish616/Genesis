  ...
  return (
    <main className="page_main flex_center flex-col">
      <section className="flex_center page_main flex-col text-center h-full">
        ...
        <h1 className="md:mt-4  text_heading_size">with <span className='text_primary_gradient_2'>Genesis</span></h1>
        <p className='w-9/12 md:w-8/12 lg:w-7/12 xl:w-6/12 text-center mt-8'>Genesis is your secure and private solution for storing passwords and files on the blockchain. Our decentralized application (Dapp) combines encryption technology with the power of blockchain to ensure your data remains safe from unauthorized access.</p>
        <div className="mt-14 ">
      ...
      <section className="page_section flex_center flex-col py-8" id='features-section'>
            <h1 className="text_primary_gradient text_heading_size">Features</h1>
            <p className='w-10/12 md:w-8/12 text-center text-sm mb-12 mt-4'>Genesis is a comprehensive data storage solution that prioritizes the security and privacy of your sensitive information. Here are some key features and benefits of DataVault:</p>
