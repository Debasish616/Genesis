...
function CredentialsForm({ type, setCredentialsData, submitForm, credentialsData, uploadingCredential }) {
  return (
    <form onSubmit={submitForm} className="flex_center flex-col gap-4 mt-4">
      <NormalInput
        ...
        value={credentialsData.websiteurl}
        onChange={(e) =>
          setCredentialsData({
            ...credentialsData,
      ...
      <NormalInput
        ...
        name="userid"
        className="input_1"
        placeholder="Enter User Id (Email/UserName/Phone)"
      ...
      {type === "create" && (
        <NormalButton
          className="btn_primary_1"
          type="submit"
          text={`${type.toLocaleUpperCase()} Credentials`}
