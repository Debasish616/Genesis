...
function StyleButton1({ className, type,text, disabled,onClick, loading = false }: IProps) {
  return (
    <button type={type ? type : "button"} onClick={onClick} disabled={disabled} className={` ${className}`}>
